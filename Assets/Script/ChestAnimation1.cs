...
public class ChestAnimation1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        chestSequence.Append(transform.DOMoveY(0, 0.45f)).SetEase(Ease.InCirc);
        ...
        chestSequence.Append(chestLid.transform.DORotate(Vector3.left * 125, 1.5f));
        chestSequence.Join(transform.DOScaleY(transform.localScale.y / 1.25f, 0.55f));
